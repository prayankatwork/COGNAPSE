...
interface AppState {
  ...
  currentView: 'onboarding' | 'landing' | 'research' | 'boards' | 'documentation' | 'dev' | 'news' | 'games' | 'creator';
  setView: (view: 'onboarding' | 'landing' | 'research' | 'boards' | 'documentation' | 'dev' | 'news' | 'games' | 'creator') => void;
